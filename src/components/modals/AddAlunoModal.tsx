    ...
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent
          ...
          style={{ animation: open ? 'fade-in 0.4s both' : 'fade-out 0.4s both' }}
        >
          <DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button type="submit" disabled={loading}
                className={`relative overflow-hidden ${loading ? "animate-pulse" : "hover:shadow-lg hover:scale-105 transition-transform"}`}>
